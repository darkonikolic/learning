# Leading questions, ambiguities, hypotheticals — premise hygiene

## What this settles

Expose **smuggled factual premises** inside ornate questions; decline adopting them wholesale; answer with **precision tightening** or **channel deferral** rather than ghost-scenario confessions.
...
~**Twenty written questions** underline buried truth-claim — speak aloud `premise = ___` explicitly.

Per underlined chunk practise **one narrowing line** aloud using allowed variants (*which example / timeframe / criterion?*).

# After turbulence — factual landing versus shame screenplay
...
Maintain tri-table after heavy human contact ASAP:

| Line | Prompt |
|------|--------|
| External moment snapshot | single neutral witnessing sentence |
| Response geometry | descriptive adjectives only (`short`, `loud`,…)|
| Adjustment lever forthcoming | solitary behavioural hinge next iteration |

Forbidden row: scripted **“everything ruined” monologue.**

**Micro-reset cluster** audible micro-exhale + shoulder slump permission + cognition tag **fresh cue fresh aperture** rehearsal post role-play equivalents.

Evening coherence check: shame soliloquy paused—table dictated or handwritten concise.

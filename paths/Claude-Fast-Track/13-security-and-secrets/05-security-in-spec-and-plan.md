...
`/gsd:secure-phase` is a GSD command that runs after execute-phase. It reads the threat mitigations documented in PLAN.md and SPEC.md and verifies they exist in the implemented code.
...
- [ ] I know when to run /gsd:secure-phase and what it produces.

...
Before running `/gsd:plan-phase 3` on task-api's PATCH endpoint, you will estimate token cost, build a context budget listing every file Claude will read and why, run the phase, compare estimated vs actual, and identify one context optimisation.
...
|-------|-----------|----------------------|------------------------|---------------|
| `/gsd:discuss-phase 3` | None | 500 | 800 | 1,300 |
| `/gsd:spec-phase 3` | PROJECT.md, prior SPEC sections | 2,500 | 2,000 | 4,500 |
| `/gsd:plan-phase 3` | SPEC.md, PROJECT.md, rules files, prior PLAN.md sections | 5,000 | 3,000 | 8,000 |
| `/gsd:execute-phase` (6 tasks, wave 1 × 3 tasks) | PLAN.md × 3, source files per task | 18,000 | 8,000 | 26,000 |
| `/gsd:execute-phase` (wave 2 × 3 tasks) | PLAN.md × 3, source files per task | 15,000 | 6,000 | 21,000 |
| `/gsd:verify-work` | SPEC acceptance criteria, targeted output | 2,000 | 500 | 2,500 |
| `/gsd:review` | Changed source files | 4,000 | 1,500 | 5,500 |
...
Before running `/gsd:plan-phase 3`, list every file Claude will likely read during execute-phase and classify each as required-for-every-task or required-for-some-tasks.
...
|-------|-----------------|---------------|-------|-----------|
| spec-phase | 4,500 | ___ | ___ | ___ |
| plan-phase | 8,000 | ___ | ___ | ___ |

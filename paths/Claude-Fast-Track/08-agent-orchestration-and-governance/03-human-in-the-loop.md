...
## Approval gates in GSD

GSD encodes HITL as explicit approval gates in the workflow. These are the checkpoints where human review is required before the next phase begins.

**Gate 1: CONTEXT.md approval (before plan-phase).**
You review what GSD gathered about the task — goals, constraints, non-goals, risks — and confirm it is correct before planning begins. Approving CONTEXT.md means: "this is the right problem and these are the right constraints."
...
You run `/gsd:verify-work` or equivalent and confirm the implementation matches the SPEC before creating a PR. Approving verification means: "the code does what the SPEC says it should do."
...
**Scenario 4: GSD ask-phase produces a CONTEXT.md that misunderstands the goal.**
...
- [ ] I know the three GSD approval gates: CONTEXT.md, PLAN.md, verification.

...
GSD protection: executor agents read PLAN.md (ground truth for the task) before acting, and their output is verified via git commits (ground truth for completion).

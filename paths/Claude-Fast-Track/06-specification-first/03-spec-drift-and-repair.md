...
- A validate-phase check reports coverage gaps between tests and SPEC
...
**Rule 5: Run validate-phase as a drift detector, not just a coverage reporter.**
...
- [ ] I run validate-phase after execute and treat coverage gaps as potential drift signals
